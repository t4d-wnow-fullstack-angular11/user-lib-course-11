...
import { createAction, props, createReducer, on, StoreModule, createSelector } from '@ngrx/store';
...
const setCurrentUser = createAction('[UserLib] Set Current User', props());
const clearCurrentUser = createAction('[UserLib] Clear Current User');
const loginUser = createAction('[UserLib] Login User', props());
const logoutUser = createAction('[UserLib] Logout User');

const initialState = {};
const ɵ0 = (_, { currentUser }) => currentUser, ɵ1 = () => ({});
const currentUserReducer = createReducer(initialState, on(setCurrentUser, ɵ0), on(clearCurrentUser, ɵ1));

class CurrentUserEffects {
...
const StoreFeatureModule = StoreModule.forFeature('user', { currentUser: currentUserReducer });
const EffectsFeatureModule = EffectsModule.forFeature([CurrentUserEffects]);
class UserLibModule {
}
...
const ɵ0$1 = (state) => state.user.currentUser, ɵ1$1 = currentUser => currentUser;
const selectCurrentUser = createSelector(ɵ0$1, ɵ1$1);
...
export { AllowedRolesGuardService, AuthorizationInterceptorService, ChangePasswordFormComponent, CurrentUser, CurrentUserComponent, EffectsFeatureModule, LoggedInGuardService, LoginFormComponent, StoreFeatureModule, UserLibModule, UserProfileComponent, UsersService, clearCurrentUser, loginUser, logoutUser, selectCurrentUser, setCurrentUser, ɵ0$1 as ɵ0, ɵ1$1 as ɵ1, initialState as ɵa, currentUserReducer as ɵb, CurrentUserEffects as ɵc };
